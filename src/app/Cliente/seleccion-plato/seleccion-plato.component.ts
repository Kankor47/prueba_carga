...
@Component({
  selector: 'app-seleccion-plato',
  templateUrl: './seleccion-plato.component.html',
  styleUrls: ['./seleccion-plato.component.css'],
  animations: [
...
export class SeleccionPlatoComponent implements OnInit{
  ...
  columnsToDisplay = ["nombre_categoria","nombre_platillo"];
  expandedElement: PeriodicElement | null;

  constructor(public dialog: MatDialog, private rest:RestService, private router:Router) {
